...
final class AlumnoRepository
{
    ...
    public function create(array $alumno): int
    {
        ...
        $statement = $this->connection->prepare($sql);
        $statement->bind_param('isssss', $noCuenta, $primerApellido, $segundoApellido, $nombres, $correo, $contacto);
        $statement->execute();
    ...
    public function update(int $id, array $alumno): void
    {
        ...
        $statement = $this->connection->prepare($sql);
        $statement->bind_param('isssssi', $noCuenta, $primerApellido, $segundoApellido, $nombres, $correo, $contacto, $id);
        $statement->execute();
    }
